...
function Class() {
   ...
   return (
      <div className="">
         ...
         <Table
            colList={["Mã số", "Họ và tên", "Giới tính", "Ngày sinh", "Nơi sinh", ""]}
         >
                           ...
                           {loading ? (
                              ...
                              >
                                 {globalStudents.map((item, index) => {
                                    const active = !!selectedStudents.find(
                                       (st) => st.id === item.id
                                    );
                                    return (
                                       <tr
                        ...
                        >
                           <div className={`flex -mx-[10px] w-full`}>
                              <MyInput
                                 width={"w-[50%] px-[10px]"}
                                 onChange={(e) =>
                                    handleSetData("className", e.target.value, true)
                                 }
                                 className=""
                                 title="Tên lớp"
                              ...
                              <MyInput
                                 width={"w-[50%] px-[10px]"}
                                 onChange={(e) =>
                                    handleSetData("id", e.target.value, true)
                                 }
                                 title="Mã số"
                           ...
                           <div className={`flex -mx-[10px] w-full`}>
                              <MyInput
                                 width={"w-[50%] px-[10px]"}
                                 onChange={(e) =>
                                    handleSetData("capacity", e.target.value, true)
                                 }
                                 className=""
                                 title="Sức chứa"
