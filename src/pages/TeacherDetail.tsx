...
function TeacherDetail() {
   ...
   useEffect(() => {
      const handleGetTeacher = async () => {
         ...
         const teacher = await myGetDoc({
            collection: "teachers",
            id: params.teacher_id,
         });

         if (teacher.exists()) {
            const teacherData = teacher.data() as TeacherType;

            // const account = await myGetDoc({
            //    collection: "accounts",
   ...
   return (
      <div>
         ...
         >
            <div className="w-[25%] px-[10px] flex-shrink-0">
            ...
            <div className="w-[75%] px-[10px] h-full">
